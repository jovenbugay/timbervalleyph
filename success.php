...
<html lang="en">
    <head>
        ...
        <title>Success - Timber Valley PH</title>
        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    <h1 class="mx-auto my-0 text-uppercase mb-3">Account Successfully Created</h1>

                    <a class="btn btn-primary" href="login.php">Click here to login</a>
