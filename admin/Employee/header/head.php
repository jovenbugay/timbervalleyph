                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="../Employee/Employee_Dashboard.php" class="nav-link active">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <a href="e_productlist.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_terms.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_orders.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_billing.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_collection.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_sales.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_collection_report.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_ledger.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_accounts_r.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="e_users.php" class="nav-link">
