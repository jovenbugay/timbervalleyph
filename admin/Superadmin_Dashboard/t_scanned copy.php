                  ...
                  <tbody>
                    <?php
                      ...
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-edit<?php echo $id;?>">View Attachment</button></td>
                     
                        <td><a href="download.php?image=<?php echo "https://timbervalleyph.com/customer/"."".$row['att_path'];?>"><button type="button" <?php echo $disabled;?> id="dload" name = "dload"class="btn btn-success btn-sm">Download Attachment</button></a></td>
