  ...
  <input type="hidden" name = "termid" id="termid" class="form-control" value = "<?php echo $row['terms_id'];?>" readonly>
        ...
        <br>
        <input type="text" name = "termdesc" id="termdesc" class="form-control" value = "<?php echo $row['terms_desc'];?>"> 
        <br>
        <input type="text" name = "termdisc" id="termdisc" class="form-control" value = "<?php echo $row['terms_discount'];?>">
