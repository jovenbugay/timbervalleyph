  ...
  <div class="modal fade" id="modal-delete<?php echo $id;?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="process/deletebilling_process.php" method="POST" enctype='multipart/form-data'>
        ...
        <input type="date" name = "b_date" class="form-control" value = "<?php echo $row['billing_date'];?>" readonly>
        </br>
        <input type="text" name = "b_price" class="form-control" value = "<?php echo number_format($row['b_amount'],2);?>" readonly>
        </div>
