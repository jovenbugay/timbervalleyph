            ...
            <div class="card">    
                ...
                <table id="example1" class="table table-bordered table-striped">
                      ...
                      //  while ($row = $result->fetch_array()){
                        ...
                        $query0=mysqli_query($con,"SELECT * FROM t_users order by id desc")or die(mysqli_error($con));
                      ...
                      <tr>
                        ...
                        ?></td>
                        <td>
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-edit<?php echo $id;?>">Edit</button> |
                          <?php 
                                        if ($row0['deleted'] == "1"){
                                          echo '<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-recover'.$id.'">Restore</button>';
                                        }else if ($row0['deleted'] == "0"){
                                          echo '<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete'.$id.'">Delete</button>';
                                        }
                          ?>
