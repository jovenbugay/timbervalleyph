...
// SELECT a.order_id,b.customer_fname,b.customer_lname,SUM(c.price * c.qty) as total_price FROM t_order_details as a LEFT join t_customers as b 
// on a.order_customer_id = b.customer_id 
// left join t_cart as c on c.guest_id = a.order_guest_id where a.order_id ='$selectdata'
// group by a.order_id
$selectdata = $_POST['selectdata'];
$result = mysqli_query($con,"SELECT a.order_id,b.customer_fname,b.customer_lname,SUM(c.price * c.qty) as total_price,d.b_balance FROM t_order_details as a LEFT join t_customers as b 
on a.order_customer_id = b.customer_id 
