                  ...
                  <tbody>
                    <?php
                      ...
                      //  while ($row = $result->fetch_array()){
                        ...
                        $query0=mysqli_query($con,"SELECT a.order_id,b.customer_fname,b.customer_lname,SUM(c.price * c.qty) as total_price,a.order_date FROM t_order_details as a 
                        LEFT join t_customers as b 
                        on a.order_customer_id = b.customer_id 
                        left join t_cart as c on c.guest_id = a.order_guest_id
                        where  a.order_payment_status ='UNPAID' group by a.order_id")or die(mysqli_error());
                      ...
                      <td><?php echo number_format ($row0['total_price'],2);?></td>
                      </tr>
