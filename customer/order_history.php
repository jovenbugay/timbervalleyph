...
<head>
  ...
  <title>Order History - Timber Valley PH</title>
  ...
  <!-- Theme style -->
  <!-- <link rel="stylesheet" href="https://unpkg.com/@webpixels/css@1.0.1/dist/index.css"> -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
              ...
              LEFT JOIN t_shipping_details as b ON a.order_shipping_id = b.sd_id
              LEFT JOIN t_payment_terms as c ON a.order_payment_terms = c.terms_id
              where a.order_customer_id = '$customer_id' AND order_status = '1' OR order_status = '2' OR order_status = '3' OR order_status = '4' order by order_id desc ");
              ...
              ?>
                ...
                <tr >
                  <td><a href="" data-toggle="modal" data-target=".bd-example-modal-lg-<?php echo $row['order_id']; ?>"><?php echo $row['order_id']; ?></a>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="order-id mt-5">
                            ...
                            <h5 class="text-center">#<?php echo $row['order_id']; ?></h5>
                        </div>
                        ...
                        <div class="order-list mt-5">
                               ...
                               <table class="table table-striped">
                                    ...
                                    <?php
                                    $resultcart = mysqli_query($con,"SELECT * FROM t_cart as a 
                                    LEFT JOIN t_products as b ON a.product_id = b.product_id 
                                    LEFT JOIN t_order_details as c ON a.guest_id = c.order_guest_id
                                ...
                                <table class="table2 float-right">
                                <tr>
                                        <td></td>
                                        <td></td>
                                        <td></td>
